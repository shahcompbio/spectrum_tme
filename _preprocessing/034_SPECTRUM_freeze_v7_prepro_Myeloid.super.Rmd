...
# Filtering out doublet and dissociated clusters
...
```{r chunk_45, fig.width=18, fig.height=6}
...
### macrophage diffusion maps

```{r chunk_150, fig.width=12, fig.height=4}

## subset macrophages
seu_obj_mp <- seu_obj_sub %>%
  subset(subset = cluster_label %in% grep("^M1|^M2|Cycling.M|Clearing.M", unique(seu_obj_sub$cluster_label), value = T)) %>%
  RunUMAP(dims = 1:50, reduction = "harmony", reduction.name = "umapharmony", reduction.key = "umapharmony_")

write_rds(seu_obj_mp, "/work/shah/uhlitzf/data/SPECTRUM/freeze/v7/Macrophages_processed.rds")
...
write_rds(seu_obj_dc, "/work/shah/uhlitzf/data/SPECTRUM/freeze/v7/DCs_processed.rds")
...
# 
# write_rds(seu_obj_mp_sub, "/work/shah/uhlitzf/data/SPECTRUM/freeze/v7/Macrophages_processed_filtered.rds")
# 
# dpt_obj <- DPT(dc_obj)
# write_rds(dpt_obj, "/work/shah/uhlitzf/data/SPECTRUM/freeze/v7/Macrophages_sub_dpt.rds")
# seu_obj_mp_sub$DPT1 <- dpt_obj$DPT1
# 
# write_rds(seu_obj_mp_sub, "/work/shah/uhlitzf/data/SPECTRUM/freeze/v7/Macrophages_processed_filtered.rds")
# seu_obj_mp_sub <- read_rds("/work/shah/uhlitzf/data/SPECTRUM/freeze/v7/Macrophages_processed_filtered.rds")
