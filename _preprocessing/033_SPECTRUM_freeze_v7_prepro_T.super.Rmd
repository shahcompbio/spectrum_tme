...
#   seu_obj_sub_sub <- AddModuleScore(seu_obj_sub_sub, features = broad_pws[i], name = names(broad_pws)[i])
#   seu_obj_sub_sub[[names(broad_pws)[i]]] <- seu_obj_sub_sub[[paste0(names(broad_pws)[i], "1")]]
#   seu_obj_sub_sub[[paste0(names(broad_pws)[i], "1")]] <- NULL
...
#   seu_obj_sub_sub <- AddMetaData(seu_obj_sub_sub, metadata = progeny_list[[i]],
...
set.seed(123)
seu_obj_sample <- subset(seu_obj_sub_sub, cells = seu_obj_sub_sub$cell_id[sample(1:ncol(seu_obj_sub_sub), 10000)])
