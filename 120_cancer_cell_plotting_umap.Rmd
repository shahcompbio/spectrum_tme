...
ggdraw() +
  ...
  draw_plot(total_numbers_cell_type, x = 0.725, y = 0.652, width = 0.16, height = 0.315) +
  ## right middle
...
ggsave(filename = "_fig/002_cohort/002_cohort_umaps.png", width = 20, height = 10)
ggsave(filename = "_fig/002_cohort/002_cohort_umaps.pdf", width = 20, height = 10)
