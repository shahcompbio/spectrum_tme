...
umap_phase <- base_umap +
  ggrastr::geom_point_rast(aes(UMAP_1, UMAP_2, color = Phase), size = pt.size, alpha = pt.alpha, raster.dpi = dpi) +
...
ggsave(filename = "_fig/002_cohort/002_cohort_umaps_v7.png", width = 20, height = 10)
ggsave(filename = "_fig/002_cohort/002_cohort_umaps_v7.pdf", width = 20, height = 10)
...
figS1_panel
ggsave("_fig/002_cohort/002_supplementary_umap_v7.pdf", figS1_panel, width = 16, height = 9)
