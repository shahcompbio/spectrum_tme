...
pm_score_tbl <- read_tsv("/work/shah/uhlitzf/data/SPECTRUM/freeze/v7/patient_mixing_scores.tsv") %>%
  ...
  left_join(distinct(meta_tbl, patient_id_short, .keep_all = T), by = "patient_id_short") %>% 
  filter(cell_type != "Other")
...
# ggsave_nodb("_fig/_paper/01_patient_mixing_plot_v5.pdf", mixing_plot_cell_type,
#        width = 3, height = 5)
...
ggsave_nodb("_fig/002_cohort/002_patient_mixing_mutsig.pdf", width = 6, height = 9)
ggsave("_fig/002_cohort/002_patient_mixing_mutsig.png", width = 6, height = 9)

```

[_fig/002_cohort/002_patient_mixing_mutsig.pdf]("_fig/002_cohort/002_patient_mixing_mutsig.pdf")

[_fig/002_cohort/002_patient_mixing_mutsig.png]("_fig/002_cohort/002_patient_mixing_mutsig.png")
...
ggsave_nodb("_fig/002_cohort/002_patient_mixing_mutsig_patient.pdf", width = 18, height = 9)
ggsave("_fig/002_cohort/002_patient_mixing_mutsig_patient.png", width = 18, height = 9)

```

[_fig/002_cohort/002_patient_mixing_mutsig_patient.pdf](_fig/002_cohort/002_patient_mixing_mutsig_patient.pdf)

[_fig/002_cohort/002_patient_mixing_mutsig_patient.png](_fig/002_cohort/002_patient_mixing_mutsig_patient.png)
...
ggsave_nodb("_fig/002_cohort/002_patient_mixing_tests.pdf", pm_comparisons, width = 5, height = 4)
ggsave("_fig/002_cohort/002_patient_mixing_tests.png", pm_comparisons, width = 5, height = 4)

```

[_fig/002_cohort/002_patient_mixing_tests.pdf](_fig/002_cohort/002_patient_mixing_tests.pdf)

[_fig/002_cohort/002_patient_mixing_tests.png](_fig/002_cohort/002_patient_mixing_tests.png)
...
write_rds(full_grid1, "_fig/002_cohort/002_cohort_umaps_v7.1.rds")
ggsave(filename = "_fig/002_cohort/002_cohort_umaps_v7.1.png", full_grid1, width = 20, height = 10)
ggsave_nodb(filename = "_fig/002_cohort/002_cohort_umaps_v7.1.pdf", full_grid1, width = 20, height = 10)

```

[_fig/002_cohort/002_cohort_umaps_v7.1.pdf](_fig/002_cohort/002_cohort_umaps_v7.1.pdf)

[_fig/002_cohort/002_cohort_umaps_v7.1.png](_fig/002_cohort/002_cohort_umaps_v7.1.png)
...
write_rds(full_grid2, "_fig/002_cohort/002_cohort_umaps_v7.2.rds")
ggsave(filename = "_fig/002_cohort/002_cohort_umaps_v7.2.png", full_grid2, width = 20, height = 10)
ggsave_nodb(filename = "_fig/002_cohort/002_cohort_umaps_v7.2.pdf", full_grid2, width = 20, height = 10)

```

[_fig/002_cohort/002_cohort_umaps_v7.2.pdf](_fig/002_cohort/002_cohort_umaps_v7.2.pdf)

[_fig/002_cohort/002_cohort_umaps_v7.2.png](_fig/002_cohort/002_cohort_umaps_v7.2.png)
...
write_rds(full_grid3, "_fig/002_cohort/002_cohort_umaps_v7.3.rds")
ggsave(filename = "_fig/002_cohort/002_cohort_umaps_v7.3.png", full_grid3, width = 20, height = 10)
ggsave_nodb(filename = "_fig/002_cohort/002_cohort_umaps_v7.3.pdf", full_grid3, width = 20, height = 10)

```

[_fig/002_cohort/002_cohort_umaps_v7.3.pdf](_fig/002_cohort/002_cohort_umaps_v7.3.pdf)

[_fig/002_cohort/002_cohort_umaps_v7.3.png](_fig/002_cohort/002_cohort_umaps_v7.3.png)
...
ggsave("_fig/002_cohort/002_supplementary_umap_v7.png", figS1_panel, width = 16, height = 9)
ggsave_nodb("_fig/002_cohort/002_supplementary_umap_v7.pdf", figS1_panel, width = 16, height = 9)
write_rds(figS1_panel_rds, "_fig/002_cohort/002_supplementary_umap_v7.rds")


```

[_fig/002_cohort/002_supplementary_umap_v7.pdf](_fig/002_cohort/002_supplementary_umap_v7.pdf)

[_fig/002_cohort/002_supplementary_umap_v7.png](_fig/002_cohort/002_supplementary_umap_v7.png)
